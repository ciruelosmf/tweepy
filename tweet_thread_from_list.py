...
consumer_key = "T0o6P1dgCDRBWrwP"
consumer_secret="NguxUw2GoB"
access_token = "1363C8"
access_token_secret = "HwgU78AkT4MitFBzo6KymJv"
bearer_token = "AAAA49EEj9"
...
f = list_links[random.randint(0,len(list_links))][0]
print(str(f))
